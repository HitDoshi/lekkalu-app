...
import { AssetsCategoriesType } from '@/types/balance-sheet'
const { width, height } = Dimensions.get('window')

// Interface for props specific to SelectAssetsItem
interface SelectAssetsItemProps {
  selectedAssetstype: AssetsCategoriesType;
  setSelectedAssetsType: (type: AssetsCategoriesType) => void;
  ...
  const theme = useTheme();
    return (
      <Select value={props.selectedAssetstype} onValueChange={props.setSelectedAssetsType} disablePreventBodyScroll {...props}>
        <Select.Trigger width={width - 1000} minHeight={36} iconAfter={ChevronDown} height={'$4'} paddingVertical={5} paddingHorizontal={10}>
